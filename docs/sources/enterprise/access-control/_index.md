...
Fine-grained access control is currently available for the following capabilities:

- [Explore]({{< relref "../../explore/_index.md" >}}) 
- [Managing Users]({{< relref "../../manage-users/_index.md" >}})
...
- [Manage Grafana Enterprise license]({{< relref "../license/_index.md" >}})
- [Provisioning Grafana]({{< relref "../../administration/provisioning/_index.md" >}})
- [Reporting]({{< relref "../reporting.md" >}})
- [View server information]({{< relref "../../administration/view-server/_index.md" >}})

To learn more about specific endpoints where you can use access control, refer to [Permissions]({{< relref "./permissions.md" >}}) and to the relevant [API]({{< relref "../../http_api/_index.md" >}}) guide:
